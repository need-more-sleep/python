...
import sys
from PyQt5.QtWidgets import QApplication, QWidget, QInputDialog, QLineEdit, QFileDialog, QPushButton, QHBoxLayout, QVBoxLayout, QLabel
from PyQt5.QtGui import QIcon
import pandas as pd
import os

def invert_Scode_1(num):
...
class App(QWidget):
    ...
    def __init__(self):
        ...
        select_file_button.move(230,250)
        
        done_button = QPushButton(' execute ')
        done_button.move(150,250)
        
        
        select_file_1_button = QPushButton(' Select File ')
        select_file_1_button.move(230,250)
        
        done_1_button = QPushButton(' execute 1')
        done_1_button.move(150,250)
        
        done_2_button = QPushButton(' execute 2')
        done_2_button.move(150,450)
        
        done_3_button = QPushButton(' execute 3')
        done_3_button.move(150,450)
        
        
        select_file_button.clicked.connect(self.select_file_button_clicked)
        done_button.clicked.connect(self.done_button_clicked)
        
        select_file_1_button.clicked.connect(self.select_file_1_button_clicked)
        done_1_button.clicked.connect(self.done_1_button_clicked)
        
        done_2_button.clicked.connect(self.done_2_button_clicked)
        done_3_button.clicked.connect(self.done_3_button_clicked)
        
        
        horizontal_box1 = QHBoxLayout()
        horizontal_box1.addWidget(select_file_button)
        horizontal_box1.addWidget(done_button)
        
        horizontal_box2 = QHBoxLayout()
        horizontal_box2.addWidget(select_file_1_button)
        horizontal_box2.addWidget(done_1_button)
        horizontal_box2.addWidget(done_2_button)
        horizontal_box2.addWidget(done_3_button)
    ...
    def select_file_1_button_clicked(self):
        self.initUI()
        
    def done_1_button_clicked(self):
        self.cal_1()
        
    def done_2_button_clicked(self):
        self.cal_2()
        
    def done_3_button_clicked(self):
        self.cal_3()
        
    def cal_1(self):
        
        os.chdir(self.dic)
        data=pd.read_csv(self.class_filename, delimiter='\t',header=None,encoding='latin-1')
        data_2=data.loc[1:9635767,0:23]
        data_3=data_2.loc[:,[12,11,1,0,0,2,4,7,22,23]]
    ...
    def cal_2(self):
        ...
        #data_3=self.data
        os.chdir(self.dic)
        data_3=pd.read_csv(self.class_filename,encoding='latin-1')
        ...
        Scode1=data_3['Scode1']
        Scode2=data_3['Scode2']
        Bcode=data_3['Bcode']
        Ccode1=data_3['Ccode1']
        Ccode2=data_3['Ccode2']
        Fcode=data_3['Fcode']
        Ocode=data_3['Ocode']
        Wcode=data_3['Wcode']
        ...
        Lcode=data_3['Lcode']
        Mcode=data_3['Mcode']
        LMcode=data_3['LMcode']
        
        
        count_1=0
        
        while count_1<=1000000:
            
            a1=Scode1[count_1]
            a1=invert_Scode_1(a1)
            real_Scode1.append(a1)
            
            a2=Scode2[count_1]
            a2=invert_Scode_2(a2)
            ...
            a4=Ccode1[count_1]
            a4=invert_Ccode_1(a4)
            real_Ccode1.append(a4)
            
            a5=Ccode2[count_1]
            a5=invert_Ccode_2(a5)    
        ...
        final=[real_Scode1,real_Scode2,real_Bcode,real_Ccode1,real_Ccode2,real_Fcode,real_Ocode,real_Wcode,real_Lcode,real_Mcode,real_LMcode]
        df_3=pd.DataFrame(final)
        df_3=df_3.T
        df_3.columns=['Scode1','Scode2','Bcode','Ccode1','Ccode2','Fcode','Ocode','Wcode','Lcode','Mcode','LMcode']
    ...
    def cal_3(self):
        ...
        test_1=self.kt_A.groupby('Ncode')
        ...
        test_2=self.kt_B.groupby('Ncode')
    ...
    def find_path(self):
        print(self.class_filename)
        
        tunning=self.class_filename.split('/')
        
        tunning_len = len(tunning)
        
        count=0
        
        output=''
        
        while ( count< tunning_len-1):
            
            
            if count==0:
                output=output+tunning[count]
    ...
    def calcul(self):
        ...
        sc_exe=pd.read_csv(self.class_filename,encoding='utf-8')
